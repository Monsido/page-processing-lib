...
export class DataCollector {
    ...
    async collectData (html: HTMLElement): Promise<{dom_tree:TreeType, css:CssType, html:string, v: string, vv: { w: number, h: number }}> {
        ...
        return { dom_tree: this.tree, css: this.css, html: cleanedHtml, v: version, vv: { w: width, h: height } };
    }
